  ...
  return (
    <>
      <div className="ct_mobile_width">
        <div className=" ">
          <div className="pt-4  ">
            <a onClick={() => HandleMyProfile()} className="d-flex gap-1">
              <div className="px-15">
                <img src={profile_pic} alt="" className="ct_img_36" />
              </div>
              <div className="flex-1 ct_border_btm pb-15">
                <h4 className="ct_fs_14 ct_fw_700 mb-1 ct_black_clr">haroldrobert11</h4>
                <p className="ct_7C7D7E_text_clr ct_fs_13 mb-0">
                  View your Profile
                </p>
              </div>
            </a>
            <a onClick={() => HandleWallet()} className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M3 6V20H21V12.5C21 11.6716 21.6716 11 22.5 11C23.3284 11 24 11.6716 24 12.5V23H0V3L21 1V6.5C21 7.32843 20.3284 8 19.5 8C18.6716 8 18 7.32843 18 6.5V4L3 6Z" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M0 7.5C0 6.67157 0.671573 6 1.5 6C4.32241 6 24 6.5 24 6.5V15C24 15.8284 23.3284 16.5 22.5 16.5C21.6716 16.5 21 15.8284 21 15V9H1.5C0.671573 9 0 8.32843 0 7.5Z" fill="#050505" />
            ...
            <a onClick={() => HandleFriends()} className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <circle cx="12" cy="6" r="4" fill="#050505" />
                  <circle cx="20" cy="9" r="3" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M6 17C6 13.5 7.51472 12 10 12H14C16.4853 12 18 13.5 18 17V23H15V16.5C15 15.6025 14.3284 15 13.5 15H10.5C9.67157 15 9 15.6025 9 16.5V23H6V17Z" fill="#050505" />
            ...
            <a onClick={() => HandleReferrals()} className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12 7C13.1046 7 14 6.10457 14 5C14 3.89543 13.1046 3 12 3C10.8954 3 10 3.89543 10 5C10 6.10457 10.8954 7 12 7ZM12 10C14.7614 10 17 7.76142 17 5C17 2.23858 14.7614 0 12 0C9.23858 0 7 2.23858 7 5C7 7.76142 9.23858 10 12 10Z" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M5 19C6.10457 19 7 18.1046 7 17C7 15.8954 6.10457 15 5 15C3.89543 15 3 15.8954 3 17C3 18.1046 3.89543 19 5 19ZM5 22C7.76142 22 10 19.7614 10 17C10 14.2386 7.76142 12 5 12C2.23858 12 0 14.2386 0 17C0 19.7614 2.23858 22 5 22Z" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M19 19C20.1046 19 21 18.1046 21 17C21 15.8954 20.1046 15 19 15C17.8954 15 17 15.8954 17 17C17 18.1046 17.8954 19 19 19ZM19 22C21.7614 22 24 19.7614 24 17C24 14.2386 21.7614 12 19 12C16.2386 12 14 14.2386 14 17C14 19.7614 16.2386 22 19 22Z" fill="#050505" />
            ...
            <a onClick={() => HandleHowWorks()} className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M10.5 6H13.5V9H10.5V6Z" fill="#050505" />
                  <path d="M10.5 11H13.5V18H10.5V11Z" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21ZM12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z" fill="#050505" />
                </svg>
              </div>
              <div className="flex-1 ct_border_btm pb-15 pt-15">
            ...
            <a className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M12 20H24V1H0V20H3V24L12 20ZM6 19.3837L11.3634 17H21V4H3V17H6V19.3837Z" fill="#050505" />
            ...
            <a onClick={() => HandleLogin()} className="d-flex gap-1 align-items-center">
              <div className="px-15">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                  <path d="M3 3V21H13V24H0V0H13V3H3Z" fill="#050505" />
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M18.3787 10.5001L14.9393 7.06077L17.0607 4.93945L24.1213 12.0001L17.0607 19.0608L14.9393 16.9395L18.3787 13.5001H6V10.5001H18.3787Z" fill="#050505" />
                </svg>
              </div>
              <div className="flex-1 ct_border_btm pb-15 pt-15">
