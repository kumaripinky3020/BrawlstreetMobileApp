...
function OpenGames() {
    ...
    const get_all_games = () => {
        axios({
            ...
            console.log(res.data.data, "get_all_games")
                    ...
                    <div className="ct_overflow_hidden">
                        <div className="ct_open_game_tab">
                            <ul className="nav nav-tabs">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link position-relative" data-bs-toggle="tab" href="#Invitations"> <span className="ct_notification_badge ct_invitation_badge">2</span>Invitations</a>
                                </li>
                            </ul>
                                        ...
                                        <a onClick={() => HandleInviteGameDetail()} className="text-dark">
                                            <div className="ct_game_card">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between mb-12">
                                                    <div className="d-flex gap-2 align-items-center">
                                                        <img src={profile_photo} alt="img" className="ct_img_24" />
                                                        <h5 className="ct_fs_14 ct_fw_600 mb-0">ticklishkoala607</h5>
                                                    </div>
                                                    <div className="ct_close_icon">
                                                        <img src={close} alt="img" />
                                                    </div>
                                        ...
                                        <a onClick={() => HandleInviteGameDetail()} className="text-dark">
                                            <div className="ct_game_card">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between mb-12">
                                                    <div className="d-flex gap-2 align-items-center">
                                                        <img src={profile_photo} alt="img" className="ct_img_24" />
                                                        <h5 className="ct_fs_14 ct_fw_600 mb-0">redkoala130</h5>
                                                    </div>
                                                    <div className="ct_close_icon">
                                                        <img src={close} alt="img" />
                                                    </div>
                                    ...
                                    <div className="px-15">
                                        ...
                                        <div className="pb-20 ct_border_btm mt_2">
                                            <div className="d-flex align-items-center pt-20 gap-3">
                                                ...
                                                <label for="ct_keep_login" className="ct_fs_14 ct_fw_600">Show only games with friends</label>
                                            </div>
                                        </div>
                                    </div>
