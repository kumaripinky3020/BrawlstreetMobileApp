                        ...
                        <div className="ct_dark_grey_bg_clr ct_friend_search position-relative py-2 ">
                            ...
                            <div className="ct_search_icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9 14C11.7614 14 14 11.7614 14 9C14 6.23858 11.7614 4 9 4C6.23858 4 4 6.23858 4 9C4 11.7614 6.23858 14 9 14ZM9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" fill="#7C7D7E"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M19.9392 22.0608L11.9392 14.0608L14.0605 11.9395L22.0605 19.9395L19.9392 22.0608Z" fill="#7C7D7E"></path>
                                </svg>
                            </div>
                        </div>
                        <div>
                                        ...
                                        <td className="ct_h_59">
                                            <button type='button' className="ct_button_blue ct_light_blue_btn ct_fs_11 p-1 h-auto ct_small_btn d-flex align-items-center gap-2 px-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7 15L7 1L9 1L9 15L7 15Z" fill="white" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1 7L15 7V9L1 9V7Z" fill="white" />
                                                </svg>Add</button>
                                        </td>
                                    </tr>
                                </tbody>
