                    ...
                    <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M21 7H3V4H21V7Z" fill="white" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M16 7H8V19H16V7ZM5 4H19V22H5V4Z" fill="white" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14 3H10V4H14V3ZM8 1H16V7H8V1Z" fill="white" />
                            </svg>
                        </div>
                    </div>
