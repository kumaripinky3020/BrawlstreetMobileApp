            ...
            <div className="ct_mobile_width">
                <div className="ct_login_bg ct_h-100 ">
                    <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
                        <a onClick={() => navigate("/setting")} className="ct_mob_head pt-0">
                    ...
                    <div className="ct_white_bg pt-28  ct_h-100 px-15">
                        <div className="pb-20">
                            ...
                            <input type="text" value="jonathan75" className="ct_select_option form-control w-100" />
                        </div>
                        <div className="pb-20">
                            <p className="mb-0 ct_fw_400 ct_fs_13 mb-1">Password</p>
                            <input type="password" value="12345678" className="ct_select_option form-control w-100" />
                        </div>
                        <div className="pb-20">
                            <a onClick={() => handleChangePassword()} className="ct_blue_text ct_fs_14 ct_fw_700">CHANGE PASSWORD</a>
                        </div>
                        <div className="pt-2">
                            <p className="mb-0 ct_fw_400 ct_fs_13 mb-1">Email</p>
                            <div className="position-relative">
                                <input type="email" value="jjsmith75@email.com" className="ct_select_option form-control w-100" />
