                            ...
                            <div className="d-flex align-items-center gap-3">
                                <div className="ct_setting_icon_bg">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M21 5H3V19H21V5ZM0 2V22H24V2H0Z" fill="#050505" />
                            ...
                            <div className="d-flex align-items-center gap-3">
                                <div className="ct_setting_icon_bg">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 19.5C3.5 16.4624 5.96243 14 9 14H15C18.0376 14 20.5 16.4624 20.5 19.5V23H17.5V19.5C17.5 18.1193 16.3807 17 15 17H9C7.61929 17 6.5 18.1193 6.5 19.5V23H3.5V19.5Z" fill="#050505" />
                                    </svg>
                                </div>
                                <div>
