            ...
            <div className="ct_mobile_width">
                <div className=" ">
                    ...
                    <div className="ct_grey_bg_clr ct_fixed_botom">
                        <a onClick={()=>HandlePersonalInfo()} className="ct_button_blue ct_light_blue_btn">CONTINUE</a>
                    </div>
                </div>
