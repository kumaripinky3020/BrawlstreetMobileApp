                ...
                <div className="ct_login_bg h-100 px-15">
                    ...
                    <div className="ct_login_form ct_center_css ct_h-100 ct_px_15">
                        <div className="w-100">
                            ...
                            <p className="ct_grey_text mt_15 ct_fs_14 ct_lh_20 ct_fw_400 text-center">You are joining a growing group of players who are winning money even when the stock market is doing poorly.  </p>

                            <div className="ct_bottom_fixed">
                                <div className="text-center mt-30">
                                    <a onClick={() => HandleOnboarding7()} className="ct_blue_text text-center ct_fw_600 ct_fs_14" >Next</a>
                                </div>
