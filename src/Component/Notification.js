                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div className="ct_active_notify">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14 10L12.3889 7H5V19H17V11L14 10ZM2 4V22H20V10.5L15 9.5L13 4H2Z" fill="#D8D8D8" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18 9C19.6569 9 21 7.65685 21 6C21 4.34315 19.6569 3 18 3C16.3431 3 15 4.34315 15 6C15 7.65685 16.3431 9 18 9ZM18 12C21.3137 12 24 9.31371 24 6C24 2.68629 21.3137 0 18 0C14.6863 0 12 2.68629 12 6C12 9.31371 14.6863 12 18 12Z" fill="#D8D8D8" />
                                                </svg>
                                            </div>
                                        </td>
                                        <td className="text-end">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20 6H4V18H20V6ZM1 3V21H23V3H1Z" fill="#D8D8D8" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.75208 5.16811C2.21161 4.47882 3.14292 4.29256 3.83221 4.75208L12.0002 10.1974L20.1681 4.75208C20.8574 4.29256 21.7887 4.47882 22.2482 5.16811C22.7078 5.8574 22.5215 6.78871 21.8322 7.24823L12.0002 13.8029L2.16811 7.24823C1.47882 6.78871 1.29256 5.8574 1.75208 5.16811Z" fill="#D8D8D8" />
                                                </svg>
                                            </div>
                                        </td>
                                    </tr>
