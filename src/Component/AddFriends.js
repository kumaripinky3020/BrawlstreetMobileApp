...
function AddFriends() {
        ...
        <div className="ct_h-100 ">
          ...
          <div className="ct_mob_head d-flex align-items-center pb-12 px-15">
            ...
            <div className="flex-1">
              <h4 className="text-white text-center ct_fs_18 mb-0 ct_fw_600">ADD FRIENDS</h4>
            </div>
          </div>
          ...
          <div className="ct_white_bg px-15 ">
            <div className="d-flex align-items-center gap-3 py-3 ct_border_btm">
              ...
              <div>
                <h4 className="ct_fs_14 ct_fw_700 mb-0">aa53annie</h4>
  ...
  <path d="M40 37H32C30.3431 37 29 38.3431 29 40V49V52H26V40C26 36.6863 28.6863 34 32 34H40C43.3137 34 46 36.6863 46 40V52H43V49V40C43 38.3431 41.6569 37 40 37Z" fill="#D8D8D8"/>
          ...
          <div className="ct_grey_bg_clr ct_fixed_botom d-flex align-items-center gap-3">
            <a onClick={() => handleContinue()} className="ct_button_blue ct_light_blue_btn">CONTINUE</a>
          </div>
        </div>
      </div>
    </>
