                    ...
                    <div className="ct_white_bg pt-28 ct_pb_100">
                        <div className="px-15">
                            ...
                            <div className="ct_pink_bg d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18 10H6V20H18V10ZM3 7V23H21V7H3Z" fill="#FFA800" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 6V8H7V6C7 3.23858 9.23858 1 12 1C14.7614 1 17 3.23858 17 6V8H14V6C14 4.89543 13.1046 4 12 4C10.8954 4 10 4.89543 10 6Z" fill="#FFA800" />
