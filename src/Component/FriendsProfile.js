      ...
      <div className="ct_mobile_width">
        <div className="ct_profile_gradient_bg_clr  ct_friends_gradient_bg_clr ct_h-100">
          <div className="ct_mob_head  bg-transparent d-flex align-items-center justify-content-between px-15">
            ...
            <div data-bs-toggle="modal" data-bs-target="#ct_report_popop">
              <svg xmlns="http://www.w3.org/2000/svg" width="4" height="18" viewBox="0 0 4 18" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M4 18L0 18L3.49691e-07 14L4 14L4 18ZM4 11L6.11959e-07 11L9.61651e-07 7L4 7L4 11ZM1.22392e-06 4L4 4L4 0L1.57361e-06 -3.49691e-07L1.22392e-06 4Z" fill="white" />
              </svg>
            </div>
          </div>
          <div className=" text-center ">
            ...
            <p className="ct_7F57F6_text_clr ct_fw_700 ct_fs_14 ct_letter_space_5  mb-0"><i className=" ct_fw_900">BIG BOSS</i></p>
            <div className="pt-12">
              ...
              <div className="ct_follower_count">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8 5C8.55228 5 9 4.55228 9 4C9 3.44772 8.55228 3 8 3C7.44772 3 7 3.44772 7 4C7 4.55228 7.44772 5 8 5ZM8 7C9.65685 7 11 5.65685 11 4C11 2.34315 9.65685 1 8 1C6.34315 1 5 2.34315 5 4C5 5.65685 6.34315 7 8 7Z" fill="white" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13ZM12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" fill="white" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4 13C4.55228 13 5 12.5523 5 12C5 11.4477 4.55228 11 4 11C3.44772 11 3 11.4477 3 12C3 12.5523 3.44772 13 4 13ZM4 15C5.65685 15 7 13.6569 7 12C7 10.3431 5.65685 9 4 9C2.34315 9 1 10.3431 1 12C1 13.6569 2.34315 15 4 15Z" fill="white" />
                  </svg>
                </div>
                <div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body pt-20 px-0 pb-5">
                <div className="d-flex align-items-center gap-2 py-12 ct_border_top ct_border_btm px-15" data-bs-toggle="modal" data-bs-target="#ct_unfriends_modal">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0.5 18.5C0.5 15.4624 2.96243 13 6 13H10C13.0376 13 15.5 15.4624 15.5 18.5V23H12.5V18.5C12.5 17.1193 11.3807 16 10 16H6C4.61929 16 3.5 17.1193 3.5 18.5V23H0.5V18.5Z" fill="#676869" />
                ...
                <div className="d-flex align-items-center gap-2 py-12  ct_border_btm px-15" data-bs-toggle="modal" data-bs-target="#ct_report_popop12">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21ZM12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z" fill="#676869" />
                ...
                <div className="w-100">
                  <div className="text-center pb-15">
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
                      <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M36 72C55.8823 72 72 55.8823 72 36C72 16.1177 55.8823 0 36 0C16.1177 0 0 16.1177 0 36C0 55.8823 16.1177 72 36 72Z" fill="#54A3FF" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M69 36C69 54.2254 54.2254 69 36 69C17.7746 69 3 54.2254 3 36C3 17.7746 17.7746 3 36 3C54.2254 3 69 17.7746 69 36ZM72 36C72 55.8823 55.8823 72 36 72C16.1177 72 0 55.8823 0 36C0 16.1177 16.1177 0 36 0C55.8823 0 72 16.1177 72 36ZM45.7544 26.5174C44.6629 21.6943 40.2058 18.51 35.4297 19.0627C30.6498 19.6158 27.0009 24.0444 27 29L24 28.9994C24.0012 22.5635 28.7496 16.8156 35.0848 16.0825C41.4238 15.349 47.2598 19.5777 48.6804 25.8552C50.0996 32.1265 46.6764 38.5117 40.6737 40.6728C39.6458 41.0429 38.9881 41.4139 38.5859 41.8299C38.2392 42.1886 37.9987 42.6648 37.9992 43.4995V50.0002H34.9992V43.501C34.9985 41.9617 35.4921 40.7137 36.4292 39.7446C37.3109 38.8327 38.487 38.2716 39.6574 37.8502C44.2016 36.2142 46.8473 31.3467 45.7544 26.5174ZM35 53H38V56H35V53Z" fill="#1464F4" />
                    </svg>
                  </div>
