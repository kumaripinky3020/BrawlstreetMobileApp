...
function AddFunds() {
    ...
    const HandleReviewConfirm = () => {
        navigate("/review/confirme", { state: { "card_id": selectedCardId } })
                                ...
                                <div className="d-flex align-items-center gap-3">
                                    <div className="ct_setting_icon_bg">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3 5.33333V18.6667H21V5.33333H3ZM0 2V22H24V2H0Z" fill="#050505" />
                                    ...
                                    <div class="modal fade" id="ct_delete_confirm" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-center border-0 pt-2">
                                                    <button type="button" class="ct_custom_btn  ct_green_btn  ct_close_btn" data-bs-dismiss="modal" onClick={() => deleteCardById(ob.id)} style={{ backgroundColor: "red", color: "white" }}>delete card</button>
                                                    <button type="button" class="ct_custom_btn  ct_green_btn" data-bs-dismiss="modal" style={{ color: "white" }}>back</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
