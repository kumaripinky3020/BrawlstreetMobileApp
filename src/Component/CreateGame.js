...
function CreateGame() {
    ...
    const HandleGameTypeButton = (val) => {
        if (val == "50/50") {
            ...
            console.log(val, "selectedAccessType21")
        }
        else if (val == "TOP 10") {
            setselectedGameType2(val)
            console.log(val, "selectedAccessType21")
            ...
            setselectedGameType2(val)
            console.log(val, "selectedAccessType23")
        }
    }
                    ...
                    <div className="px-15">
                        <div className="pb-20 ct_border_btm">
                            ...
                            <div className="ct_type_border">
                                ...
                                <button type='button' className={selectedGameType2 == "TOP 10" ? "active" : "unactive"} onClick={() => HandleGameTypeButton("TOP 10")}>TOP 10</button>
                            </div>
                                {}
                        </div>
                        <div className="pb-20 mt_20">
                            <p className="mb-0 ct_fw_400 ct_fs_13 mb-1"> Entry fee</p>
                            <input type="number" className="ct_select_option ct_fw_600 text-dark" onChange={(e) => setEntry_fee(e.target.value)} value={entry_fee} />
                        </div>
                    </div>
